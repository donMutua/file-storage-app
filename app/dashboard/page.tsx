...
export default function DashboardPage() {
  ...
  const { searchQuery, activeFilter, setActiveFilter } = useSearchContext()
  ...
  return (
    <div>
      ...
      <div>
        ...
        <Tabs defaultValue={activeFilter} onValueChange={handleFilterChange} className="mb-6">
        ...
        {searchQuery && (
          <div className="mb-4">
            <p className="text-sm text-[#637588]">
              Search results for "{searchQuery}" ({filteredFolders.length + filteredFiles.length} items)
            </p>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          ...
          {filteredFolders.length === 0 && filteredFiles.length === 0 && (
            <div className="col-span-full flex flex-col items-center justify-center py-12 text-center">
              <div className="mb-4 rounded-full bg-[#f0f2f4] p-4">
                <Search className="h-8 w-8 text-[#637588]" />
              </div>
              <h3 className="mb-2 text-lg font-medium text-[#111418]">No results found</h3>
              <p className="text-[#637588]">We couldn't find any files or folders matching "{searchQuery}".</p>
            </div>
          )}
        </div>
      </div>
